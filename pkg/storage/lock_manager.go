...
type LockManager interface {
	LockStage(ctx context.Context, projectName, dependenciesDigest string) (LockHandle, error)
	LockStageCache(ctx context.Context, projectName, dependenciesDigest string) (LockHandle, error)
